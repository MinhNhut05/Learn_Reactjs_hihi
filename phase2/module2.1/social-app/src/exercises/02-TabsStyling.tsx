  ...
  return (
    <button
      ...
      className={`
        ...
        /* Conditional styles dựa trên isActive */
        ${isActive
          ? '' /* Active styles */
          : '' /* Inactive styles */
        }
    ...
    <div className="p-6 bg-white rounded-lg shadow">
        ...
        <Tabs.Panels>
          <Tabs.Panel value="posts">
            ...
            <p className="text-gray-600">
              Your posts will appear here. This panel should have a gray background.
            </p>
          </Tabs.Panel>
          <Tabs.Panel value="about">
            <h3 className="font-medium text-gray-900 mb-2">About</h3>
            <p className="text-gray-600">
              Information about you. Try switching tabs to see the active styling.
            </p>
          </Tabs.Panel>
      ...
      <div className="mt-6 p-4 bg-yellow-50 rounded border border-yellow-200">
        <p className="text-sm text-yellow-800">
          <strong>Check:</strong> Active tab có màu xanh và underline? Inactive tabs có hover effect?
        </p>
      </div>
    </div>
  )
